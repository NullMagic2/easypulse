...
output_stream_list *get_output_streams(pa_context *context);               //Gets a list of output (sink) inputs.
...
uint32_t card_index);                                                      //Gets the active profile of a card.
#endif
