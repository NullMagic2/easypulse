...
pa_source_info *get_input_device_by_name(const char *source_name);         //Gets alsa name of a pulseaudio source (input device) by its name.

pa_sink_info* get_output_device_by_index(uint32_t index);                   //Gets alsa name of a pulseaudio source (input device) by its index.
